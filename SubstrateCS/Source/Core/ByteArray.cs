...
namespace Substrate.Core
{
    ...
    public sealed class XZYIntArray : IntArray, IDataArray3
    {
        private readonly int _xdim;
        private readonly int _ydim;
        private readonly int _zdim;

        public XZYIntArray(int xdim, int ydim, int zdim)
            : base(xdim * ydim * zdim)
        {
            _xdim = xdim;
            _ydim = ydim;
        ...
        public XZYIntArray(int xdim, int ydim, int zdim, int[] data)
            : base(data)
        {
            _xdim = xdim;
            _ydim = ydim;
        ...
        public override IntArray Copy()
        {
            ...
            return new XZYIntArray(_xdim, _ydim, _zdim, data);
        }
